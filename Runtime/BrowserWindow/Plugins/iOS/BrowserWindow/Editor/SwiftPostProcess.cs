...
namespace NT.Editor.BrowserWindow {
    public static class SwiftPostProcess {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath)
        {
            if (buildTarget == BuildTarget.iOS) {
                ...
                proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_BRIDGING_HEADER", "Libraries/Plugins/iOS/BrowserWindow/Source/BrowserWindow-Bridging-Header.h");

                proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_INTERFACE_HEADER_NAME", "BrowserWindow-iOS-Swift.h");
